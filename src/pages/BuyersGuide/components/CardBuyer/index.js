    ...
    <div className='card_buyer'>
        <div className='row card-content'>
                <div className='col-12 col-md-3 text-center content-left'>
                    <a href="">
                    <img src="https://www.tikibrand.com/media/buyersguide/article/image/7/2/72_dpi_jpg-2022_shutterstock_brief_-_turn_on_ambiance_turn_off_mosquitos_3_.jpg" alt="" />
                    </a>
                </div>
